...
object Libs {
    ...
    const val accompanist = "dev.chrisbanes.accompanist:accompanist-glide:${Versions.accompanist}"
    //endregion
    ...
    const val composeUiTest = "androidx.ui:ui-test-junit4:${Versions.compose}"
    //endregion
