...
private object Libs {
    ...
    const val supportConstraint = "com.android.support.constraint:constraint-layout:${Versions.constraintLayout}"
    ...
    const val kotlinJUnit = "junit:junit:${Versions.junit}"
